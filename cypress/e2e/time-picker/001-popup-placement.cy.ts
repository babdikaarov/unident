...
import { SNAPSHOT_FAULT_TOLERANCE } from '@unimed-x/e2e-testing'
import { createTimePickerPageObject } from '@unimed-x/e2e-testing/src/page-objects/time-picker.page-object.ts'
...
describe(
  ...
  () => {
    const timePickerTopLeft = createTimePickerPageObject(
      '.time-picker-top-left'
    )
    ...
    const timePickerInModal = createTimePickerPageObject(
