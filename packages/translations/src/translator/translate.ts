import { InvalidLocaleError } from '@unimed-x/shared/src/utils/stateless/errors/InvalidLocale.error'
import { TranslationVariables } from '@unimed-x/shared/src/types/translations'
