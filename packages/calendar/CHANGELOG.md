...
- add missing highlight for current day in month ([#176](https://github.com/schedule-x/schedule-x/issues/176)) ([a587001](https://github.com/schedule-x/schedule-x/commit/a587001bcb9609aa727e515b975cd095905d2395))
...
- **calendar:** prevent race condition when setting events on range update ([d62abaa](https://github.com/schedule-x/schedule-x/commit/d62abaad5cb702363302adead7222dbed8b26487))
...
- events facade ([#107](https://github.com/schedule-x/schedule-x/issues/107)) ([f529b4b](https://github.com/schedule-x/schedule-x/commit/f529b4b089c2009831d72212ccf84b252c13e7fc))
...
- month agenda event ([#680](https://github.com/schedule-x/schedule-x/issues/680)) ([94e6c81](https://github.com/schedule-x/schedule-x/commit/94e6c81301c607fedb730859104cc55a3d6e93c8))
...
- add callback onRangeUpdate ([#99](https://github.com/schedule-x/schedule-x/issues/99)) ([9c8b3d7](https://github.com/schedule-x/schedule-x/commit/9c8b3d732ff62cf07cc83c9fa4d1fe30e2c7fb3b))
...
- **calendar:** add callbacks for clicking on date and times ([#119](https://github.com/schedule-x/schedule-x/issues/119)) ([16e52a7](https://github.com/schedule-x/schedule-x/commit/16e52a70961b41e377812e65761357596126bee8))
...
- create callback onEventClick ([#118](https://github.com/schedule-x/schedule-x/issues/118)) ([cedf22a](https://github.com/schedule-x/schedule-x/commit/cedf22ae0d3ff1eabc63020844244755932a53b8))
...
- custom component date grid event ([#111](https://github.com/schedule-x/schedule-x/issues/111)) ([24f9e1d](https://github.com/schedule-x/schedule-x/commit/24f9e1d07adf46cfe70efaa08e75a0ce7d628e1b))
...
- enable keyboard- and screen reader navigation of view selection ([#153](https://github.com/schedule-x/schedule-x/issues/153)) ([d372a4a](https://github.com/schedule-x/schedule-x/commit/d372a4a74fdf87c5d14a9143a5bfa5bf9b14ef05))
...
- enable using a custom component for month agenda events ([ca4126f](https://github.com/schedule-x/schedule-x/commit/ca4126fe2f5e4e8e1e89dbefb1988a3a4ae0cc67))
- enable using a custom component for month grid events ([#114](https://github.com/schedule-x/schedule-x/issues/114)) ([8d43934](https://github.com/schedule-x/schedule-x/commit/8d43934023ae08948fe618ff8169e201d5d17680))
- enable using additional colors for events ([#88](https://github.com/schedule-x/schedule-x/issues/88)) ([95329fd](https://github.com/schedule-x/schedule-x/commit/95329fd8f5afb6120a7a5cb12ee784968d6e5fb6))
...
- expose APIs for creating custom views ([#132](https://github.com/schedule-x/schedule-x/issues/132)) ([70195c6](https://github.com/schedule-x/schedule-x/commit/70195c6cf7a802e41fc401d8c9d72311ff838c38))
...
- header navigation arrows ([#101](https://github.com/schedule-x/schedule-x/issues/101)) ([c4111ac](https://github.com/schedule-x/schedule-x/commit/c4111ac4e4071085333f08c7e9eb2cd00ddd011e))
...
- improve keyboard navigation for header buttons ([#154](https://github.com/schedule-x/schedule-x/issues/154)) ([df23573](https://github.com/schedule-x/schedule-x/commit/df2357328384d4312125ed2b43ba2d9f15a5633b))
...
- improve test lib ([#105](https://github.com/schedule-x/schedule-x/issues/105)) ([b417a6c](https://github.com/schedule-x/schedule-x/commit/b417a6c694f4663ad42e0bc6c52a0e317d7d381c))
...
- make week- and day views accessible to screen readers ([#155](https://github.com/schedule-x/schedule-x/issues/155)) ([428c8d9](https://github.com/schedule-x/schedule-x/commit/428c8d9cc434867adf75fc324564f87538e71320))
...
- rename bootstrap to render and make it take an "el" parameter ([#103](https://github.com/schedule-x/schedule-x/issues/103)) ([3bdcd4f](https://github.com/schedule-x/schedule-x/commit/3bdcd4f4e5e2f133e05ff1448fa48fdb17007cb2))
