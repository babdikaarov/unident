...
import { timePointsPerDay } from '@unimed-x/shared/src/utils/stateless/time/time-points/time-points-per-day'
...
export default class CalendarConfigImpl implements CalendarConfigInternal {
  ...
  constructor(
    ...
    this.showDayNumber = signal(showDayNumber)
